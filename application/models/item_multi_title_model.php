...
class Item_Multi_Title_model extends CI_Model {
    ...
    function update($param) {
        ...
        if (empty($param['id'])) {
            $insert_query  = GenerateInsertQuery($this->field, $param, ITEM_MULTI_TITLE);
            ...
            $update_query  = GenerateUpdateQuery($this->field, $param, ITEM_MULTI_TITLE);
    ...
    function get_by_id($param) {
        ...
        if (isset($param['id'])) {
            $select_query  = "SELECT * FROM ".ITEM_MULTI_TITLE." WHERE id = '".$param['id']."' LIMIT 1";
        } 
    ...
    function delete($param) {
		$delete_query  = "DELETE FROM ".ITEM_MULTI_TITLE." WHERE id = '".$param['id']."' LIMIT 1";
